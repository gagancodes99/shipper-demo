    ...
    <div className="min-h-screen bg-gray-50 max-w-sm mx-auto flex flex-col">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-semibold text-gray-500 -mt-0.5">
      ...
      <main className="px-4 mt-3 pb-8 space-y-4">
        {filteredJobs.length > 0 ? (
          filteredJobs.map((job) => (
            ...
            >
              ...
              <div className="mt-3">
                <button
                  className="w-full bg-blue-600 text-white py-2 rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-1"
                  onClick={(e) => {
                    e.stopPropagation();
        ...
        {activeTab === "active" && filteredJobs.length > 0 && (
          <button className="w-full py-3 text-blue-600 text-sm font-medium mt-4">
            Load more jobs
          </button>
        )}
      </main>
